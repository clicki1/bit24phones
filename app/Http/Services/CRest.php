...
class CRest
{
    ...
    const C_REST_CLIENT_ID = 'local.65ba26ea4539c0.37327799';// json or xml
    const C_REST_CLIENT_SECRET = 'cZ6mlV1FZcotxR0U4R75MEQeMWnMChm6Wd9e6y7IcKyspf8f2v';// json or xml
